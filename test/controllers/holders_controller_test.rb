...
class HoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holder" do
    assert_difference('Holder.count') do
      post holders_url, params: { holder: { name: @holder.name, passport: @holder.passport, surename: @holder.surename } }
    end
  ...
  test "should update holder" do
    patch holder_url(@holder), params: { holder: { name: @holder.name, passport: @holder.passport, surename: @holder.surename } }
